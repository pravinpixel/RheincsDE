...
{
    public partial class NewsEventsDetails : System.Web.UI.Page
    {
        ...
        public void LoadNewsEventsDetail(string RouteUrl)
        {
            ...
            {
                var getNewsEventsDetail = context.RICNews.Where(e => e.UrlDetails == NewsEventsUrl & e.Status == true).FirstOrDefault();
                ...
                NewsEventDetail = getNewsEventsDetail.DetailedDescription;

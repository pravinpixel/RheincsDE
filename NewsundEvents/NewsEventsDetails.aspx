<%@ Page Title="NewsUndEvents | RheinBrücke IT Consulting" Language="C#" MasterPageFile="~/Rheincs.Master" AutoEventWireup="true" CodeBehind="NewsEventsDetails.aspx.cs" Inherits="RheinBrucke.NewsundEvents.NewsEventsDetails" %>
    ...
    <div class="container" id="container-top">
        <div class="row">
             <ul class="breadcrumb bread  hidden-xs hidden-sm">
                 ...
                 <li><a href="../news-events" class="redColor">News & Events <span> » </span> </a></li>
        ...
        <div class="wrappernew main-container">
            ...
            <img src="<%=rootpath %>Assets/images/<%= NewsImageDetails %>" class="img-responsive center-block" alt="RheinBrücke Management Team getting the Stevie Award for Company of the year and Vetri Selvan awarded IT Executive of the year" />
            </div>--%>
            <p><%= NewsEventDetail %></p>
        </div>
    </div>

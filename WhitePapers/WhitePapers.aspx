<%@ Page Title="White Papers | RheinBrücke IT Consulting" Language="C#" MasterPageFile="~/Rheincs.Master" AutoEventWireup="true" CodeBehind="WhitePapers.aspx.cs" Inherits="RheinBrucke.WhitePapers.WhitePapers" %>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content mymodal-download">
                    ...
                    <div class="modal-body">
                     ...
                     <div class="modal-body">
                        <p>
                            <input type="text" placeholder="Company Name" id="textcompany" class="write-to-us-input" name="whitepaper-email"/>
                        </p>

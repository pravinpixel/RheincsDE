<%@ Page Title="FactSheets | RheinBrücke IT Consulting" Language="C#" MasterPageFile="~/Rheincs.Master" AutoEventWireup="true" CodeBehind="FactSheets.aspx.cs" Inherits="RheinBrucke.FactSheets.FactSheets" %>

<asp:Content ID="Content1" ContentPlaceHolderID="headerPlaceHolder" runat="server">
    <%-- <meta name="keywords" content="RheinBrücke Whitepapers, White Papers, WhitePapers." />--%>
    <%-- <meta name="Description" content="The WhitePapers from RheinBrücke, giving you insights on the recent developments in our organization." />--%>
</asp:Content>
    ...
    <div class="container" id="container-top">
        <div class="row">
            <ul class="breadcrumb bread  hidden-xs hidden-sm">
                ...
                <li class="redColor">Factsheet</li>
            </ul>
        </div>
        ...
        <div class="row" id="filter-search">
                ...
                <asp:Repeater ID="rptNewsEvents" runat="server">
                    <ItemTemplate>                     
                        <div class="col-md-3 col-xs-12 col-sm-6 success-padding-left padd-left-72">                          
                            ...
                            <br />
                              <a  style="color: #2f2f2f;" class="readmore" data-toggle="modal" data-target="#myModal-factsheets" data-id="<%# Eval("Description") %>" data-value ="<%=rootpath %>Assets/images/Factsheets/Thumbnail/<%# Eval("Thumbnail") %>">                                              
         ...
         <div class="modal fade" id="myModal-factsheets" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                ...
                <div class="modal-content mymodal-download">
                    ...
                    <div class="modal-body">
                        ...
                        <p>
                            ...
                            <input type="text" placeholder="*Your Name" id="textepicor" class="write-to-us-input" name="factsheets-name"/>
                        </p>
                        <span style="margin-top: 5px;" class="validator text-left" id="reqtextepicornameval" hidden="hidden">Enter Your Name</span>
                    </div>
                    <div class="modal-body">
                        <p>
                            <input type="text" placeholder="Company Name" id="textcompany" class="write-to-us-input" name="factsheets-email"/>
                        </p>
                    ...
                    <div class="modal-body">
                        <p>
                            <input type="text" placeholder="*Your Email Address" id="textemail" class="write-to-us-input" name="factsheets-email"/>
                        </p>
                    ...
                    <div class="modal-body">
                        <p>
                            <input type="number" placeholder="Your Mobile Number " id="textmobile" class="write-to-us-input" name="factsheets-phone"/>
                        </p>
                    ...
                    <div class="clearfix">&nbsp;</div>
                    <div class="modal-body">
                        <input type="button" id="btnepicor" class="submit-button" onclick="onFormSubmit()" data-loading-text="Submitting.." value="Submit" />
                    </div>
...
<script type="text/javascript" src="https://web.mxradon.com/t/FormTracker.js"></script>
                    ...
                    <script type="text/javascript">                         
                        function onFormSubmit() {
                            ...
                            var fieldMapping = {
                                MXHOrgCode: "17537",
                                MXHLandingPageId: "2ff1e411-9c6e-11e8-a3e9-0288bc426570",
                                MXHAsc: "",
                                mx_Name: "factsheets-name",
                                EmailAddress: "factsheets-email",
                                Mobile: "factsheets-phone"
                            };
                            ...
                            new LSQForm().captureLead(fieldMapping, "myModal-factsheets",
                            {

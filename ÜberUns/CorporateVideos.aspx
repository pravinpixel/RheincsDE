<%@ Page Title="Corporate Videos | RheinBrücke IT Consulting" Language="C#" MasterPageFile="~/Rheincs.Master" AutoEventWireup="true" CodeBehind="CorporateVideos.aspx.cs" Inherits="RheinBrucke.ÜberUns.CorporateVideos" %>
            ...
            <div class="row padd-bottom-10">
                ...
                <div class="col-md-4 ">
                    ...
                    <p class="contentSmall">
                        ...
                        <br />
                        <a data-toggle="modal" data-target="#myModal7" data-videoid="IDrR7hiizhI" data-videosite="youtube" class="video-class">Video abspielen</a>
                    </p>
                ...
                <div class="col-md-4">
                    ...
                    <p class="contentSmall">
                        ...
                        <br />
                        <a href="#" data-toggle="modal" data-target="#myModal8" data-videoid="MmXOpBXQdZM" data-videosite="youtube" class="video-class">Video abspielen</a>
                    </p>
                ...
                <div class="col-md-4">
                    ...
                    <p class="contentSmall">
                        ...
                        <br />
                        <a href="#" data-toggle="modal" data-target="#myModal18" data-videoid="t5b2gIdhyo" data-videosite="youtube" class="video-class">Video abspielen</a>
                    </p>
        ...
        <div class="row padd-bottom-10">
            ...
            <div class="col-md-4">
                ...
                <p class="contentSmall">
                    ...
                    <br />
                    <a href="#" data-toggle="modal" data-target="#myModal10" data-videoid="B-XFRUeSlUs" data-videosite="youtube" class="video-class">Video abspielen</a>
                </p>
            ...
            <div class="col-md-4">
                ...
                <p class="contentSmall">
                    ...
                    <br />
                    <a href="#" data-toggle="modal" data-target="#myModal11" data-videoid="yvtX2yqWxVg" data-videosite="youtube" class="video-class">Video abspielen</a>
                </p>
        ...
        <div class="row padd-bottom-10">
            ...
            <div class="col-md-4">
                ...
                <p class="contentSmall">
                    ...
                    <br />
                    <a href="#" data-toggle="modal" data-target="#myModal12" data-videoid="TIIjLQps44U" data-videosite="youtube" class="video-class">Video abspielen</a>
                </p>
            ...
            <div class="col-md-4">
                ...
                <p class="contentSmall">
                    ...
                    <br />
                    <a href="#" data-toggle="modal" data-target="#myModal9" data-videoid="C6sDlZCKIA4" data-videosite="youtube" class="video-class">Video abspielen</a>
                </p>

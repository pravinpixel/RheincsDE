<%@ Page Title="Case Studies | RheinBrücke IT Consulting" Language="C#" MasterPageFile="~/Rheincs.Master" AutoEventWireup="true" CodeBehind="CaseStudy.aspx.cs" Inherits="RheinBrucke.CaseStudies.CaseStudy" %>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content mymodal-download">
                    ...
                    <div class="modal-body">
                      ...
                      <div class="modal-body">
                        <p>
                            <input type="text" placeholder="Company Name" id="textcompany" class="write-to-us-input" name="casestudy-email"/>
                        </p>
                    ...
                    <div class="clearfix">&nbsp;</div>
                    <div class="modal-body">
                        <input type="button" id="btnepicor" class="submit-button " data-loading-text="Submitting.." onclick="onFormSubmit()" value="Submit" />
                    </div>
                </div>
            </div>
        </div>
